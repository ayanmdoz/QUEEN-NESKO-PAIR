            ...
            Um4r719.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    await Um4r719.sendMessage(userJid, { 
                        text: '*🌅💇Hey Dear*\n\n*Don’t Share Your Session ID With Anyone*\n\n*This IS QUEEN NESKO*\n\n*THANKS FOR USING QUEEN NESKO BOT*\n\n*CONNECT FOR UPDATES*: https://whatsapp.com/channel/0029Vb0Ei5L47Xe6rmpb4f2m\n\n*Follow Dev On Instagram*: https://instagram.com/Ayanazizh503\n' 
                    });
